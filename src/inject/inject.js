                                            ...
                                            case 8:
                                                return (
                                                    ...
                                                    (d.innerHTML = '\n          <div style="text-align:center">\n            <div style="font-size:38px;margin-bottom:15px">'
                                                        ...
                                                        .concat(
                                                            v ? "paste" : "upload",
                                                            ' in Codro or Figma</div>\n            <a style="font-size:16px;font-weight:bold;text-decoration:none;color:#87CEEB;border:2px solid #87CEEB;padding:8px 16px;border-radius:12px;display:inline-block" \n               href="https://www.builder.io/c/docs/chrome-extension" \n               target="_blank">Learn more</a>\n          </div>'
                                                        )),
                                                    [4, y(15e3)]
                                                );
                                            case 9:
